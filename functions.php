...
function add_filtry(){
	add_action( 'storefront_before_content', 'woocommerce_breadcrumb', 11);
}
add_action('wp', 'add_filtry');

function add_grupy(){
	echo do_shortcode('[br_filters_group group_id=361]');
}
add_action('storefront_before_content', 'add_grupy');